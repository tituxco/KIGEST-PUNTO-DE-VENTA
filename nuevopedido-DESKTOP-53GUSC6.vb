Public Class nuevopedido
            ...
            If modificar = True Then
                ...
                Reconectar()
                    ...
                    If Val(infocl(0)(3)) = 0 Then
                        ...
                        Dim consulta2 As New MySql.Data.MySqlClient.MySqlDataAdapter("SELECT cod, plu, cantidad, descripcion, iva,punit, ptotal,id FROM fact_items  " _
               & " where codint=" & idAPP, conexionPrinc)
                ...
                tmrcontrolarnumfact.Enabled = True
                    ...
                    Reconectar()
                    Dim consulta2 As New MySql.Data.MySqlClient.MySqlDataAdapter("SELECT cod, codint, cantidad, descripcion, iva,punit, ptotal,id FROM fact_items  " _
                    & " where id_fact=" & idFactura, conexionPrinc)
                    Dim tablaprod As New DataTable
                    Dim filasProd() As DataRow
                    consulta2.Fill(tablaprod)
    ...
    Private Sub CargarNumComprobante()
        Try
            ...
            Dim sql As New MySql.Data.MySqlClient.MySqlCommand
            sql.Connection = conexionPrinc
            sql.CommandText = "select confnume from tipos_comprobantes where donfdesc=995 and ptovta= " & DatosAcceso.IdPtoVtaDef
            sql.CommandType = CommandType.Text
            lector = sql.ExecuteReader
            lector.Read()
