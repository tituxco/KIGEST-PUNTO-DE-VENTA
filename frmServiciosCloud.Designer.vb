...
Partial Class frmServiciosCloud
    ...
    Private Sub InitializeComponent()
        ...
        Dim TreeNode49 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("ACADEMIA")
        Dim TreeNode50 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("TECNICO")
        Dim TreeNode51 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("COMBUSTIBLES/IMPUESTOS EXTRAS")
        Dim TreeNode52 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("ESPECIALES-SERVICIOS", New System.Windows.Forms.TreeNode() {TreeNode44, TreeNode45, TreeNode46, TreeNode48, TreeNode49, TreeNode50, TreeNode51})
        Dim TreeNode53 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("Mod SUELDOS")
        Dim TreeNode54 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("CONFIGURAR TERMINAL")
        Dim TreeNode55 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("CONFIGURACIONES VARIAS")
        Dim TreeNode56 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("HISTORIAL Y CONFIGURACION DE USUARIOS")
        Dim TreeNode57 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("Mod CONFIGURACIONES", New System.Windows.Forms.TreeNode() {TreeNode54, TreeNode55, TreeNode56})
        Dim TreeNode58 As System.Windows.Forms.TreeNode = New System.Windows.Forms.TreeNode("KIGEST_FACT_SIGT", New System.Windows.Forms.TreeNode() {TreeNode1, TreeNode7, TreeNode17, TreeNode43, TreeNode52, TreeNode53, TreeNode57})
        ...
        TreeNode1.Name = "NODO_GENERAL_CLIENTES"
        TreeNode1.Tag = "1"
        TreeNode1.Text = "Mod CLIENTES"
        TreeNode2.Name = "NODO_GENERAL_PRODUCTOS_ABM"
        TreeNode2.Tag = "2a"
        TreeNode2.Text = "ABM PRODUCTOS"
        TreeNode3.Name = "NODO_GENERAL_PRODUCTOS_CONSULTA"
        TreeNode3.Tag = "2b"
        TreeNode3.Text = "CONSULTA PRODUCTOS"
        TreeNode4.Name = "NODO_GENERAL_PRODUCTOS_PRECIOS"
        TreeNode4.Tag = "2c"
        TreeNode4.Text = "MANEJO DE PRECIOS"
        TreeNode5.Name = "NODO_GENERAL_PRODUCTOS_STOCK"
        TreeNode5.Tag = "2d"
        TreeNode5.Text = "MANEJO DE STOCK"
        TreeNode6.Name = "NODO_GENERAL_PRODUCTOS_PRODUCCION"
        TreeNode6.Tag = "2e"
        TreeNode6.Text = "PRODUCCION"
        TreeNode7.Name = "NODO_GENERAL_PRODUCTOS"
        TreeNode7.Tag = "2"
        TreeNode7.Text = "Mod PRODUCTOS"
        TreeNode8.Name = "NODO_GENERAL_FACTURACION_RECUPERAR"
        TreeNode8.Tag = "3a"
        TreeNode8.Text = "FC NOTAS DE CREDITO Y DEBITO"
        TreeNode9.Name = "NODO_GENERAL_FACTURACION_PRESUPUESTOS_LC"
        TreeNode9.Tag = "3b-AR01"
        TreeNode9.Text = "LISTA DE CARGA"
        TreeNode10.Name = "NODO_GENERAL_FACTURACION_PRESUPUESTOS"
        TreeNode10.Tag = "3b"
        TreeNode10.Text = "PRESUPUESTOS"
        TreeNode11.Name = "NODO_GENERAL_FACTURACION_FX"
        TreeNode11.Tag = "3c"
        TreeNode11.Text = "FX - RECIBO CONS FINAL"
        TreeNode12.Name = "NODO_GENERAL_FACTURACION_FB"
        TreeNode12.Tag = "3d"
        TreeNode12.Text = "FACTURA B/C LEGAL"
        TreeNode13.Name = "NODO_GENERAL_FACTURACION_FA"
        TreeNode13.Tag = "3e"
        TreeNode13.Text = "FACTURA A LEGAL"
        TreeNode14.Name = "NODO_GENERAL_FACTURACION_RMT"
        TreeNode14.Tag = "3f"
        TreeNode14.Text = "REMITOS"
        TreeNode15.Name = "NODO_GENERAL_FACTURACION_EXTRA_STOCK"
        TreeNode15.Tag = "3z"
        TreeNode15.Text = "DESACTIVAR STOCK"
        TreeNode16.Name = "NODO_GENERAL_FACTURACION_EXTRA"
        TreeNode16.Text = "EXTRAS>>"
        TreeNode17.Name = "NODO_GENERAL_FACTURACION"
        TreeNode17.Tag = "3"
        TreeNode17.Text = "Mod FACTURACION"
        TreeNode18.Name = "NODO_GENERAL_ADMIN_CONTABLE_RPTVTAS"
        TreeNode18.Tag = "4aa"
        TreeNode18.Text = "REPORTE DE VENTAS"
        TreeNode19.Name = "NODO_GENERAL_ADMIN_CONTABLE_RPTCOBRANZA"
        TreeNode19.Tag = "4ab"
        TreeNode19.Text = "REPORTE DE COBRANZAS"
        TreeNode20.Name = "NODO_GENERAL_ADMIN_CONTABLE_EXPORTA"
        TreeNode20.Tag = "4aj"
        TreeNode20.Text = "EXPORTACION A CITI O IVA DIGITAL"
        TreeNode21.Name = "NODO_GENERAL_ADMIN_CONTABLE_INFORMES"
        TreeNode21.Tag = "4ac"
        TreeNode21.Text = "BALANCES E INFORMES"
        TreeNode22.Name = "NODO_GENERAL_ADMIN_CONTABLE_RMT"
        TreeNode22.Tag = "4ad"
        TreeNode22.Text = "REMITOS"
        TreeNode23.Name = "NODO_GENERAL_ADMIN_CONTABLE_CHEQUES"
        TreeNode23.Tag = "4ae-4af"
        TreeNode23.Text = "MANEJO DE CHEQUES"
        TreeNode24.Name = "NODO_GENERAL_ADMIN_CONTABLE_CTACTEcLIE"
        TreeNode24.Tag = "4ag-4ah"
        TreeNode24.Text = "CUENTAS CORRIENTES CLIENTES"
        TreeNode25.Name = "NODO_GENERAL_ADMIN_CONTABLE_CTACTEpROVEE"
        TreeNode25.Tag = "4ai"
        TreeNode25.Text = "CUENTAS CORRIENTES PROVEEDORES"
        TreeNode26.Name = "NODO_GENERAL_ADMIN_CONTABLE_PLANCTAS"
        TreeNode26.Tag = "4ak"
        TreeNode26.Text = "PLAN DE CUENTAS"
        TreeNode27.Name = "NODO_GENERAL_ADMIN_CONTABLE_LIBROS"
        TreeNode27.Tag = "4ak"
        TreeNode27.Text = "LIBROS (DIARIO Y MAYOR)"
        TreeNode28.Name = "NODO_GENERAL_ADMIN_CONTABLE_ASIENTOS"
        TreeNode28.Tag = "4al"
        TreeNode28.Text = "ASIENTOS CONTABLES"
        TreeNode29.Name = "NODO_GENERAL_ADMIN_CONTABLE"
        TreeNode29.Tag = "4a"
        TreeNode29.Text = "CONTABLE"
        TreeNode30.Name = "NODO_GENERAL_ADMIN_CAJA_MASTER"
        TreeNode30.Tag = "4ba"
        TreeNode30.Text = "MASTER CAJAS"
        TreeNode31.Name = "NODO_GENERAL_ADMIN_CAJA_DIARIA_MOV"
        TreeNode31.Tag = "4bba"
        TreeNode31.Text = "MOVIMIENTOS DE CAJA"
        TreeNode32.Name = "NODO_GENERAL_ADMIN_CAJA_DIARIA"
        TreeNode32.Tag = "4bb"
        TreeNode32.Text = "CAJA DIARIA"
        TreeNode33.Name = "NODO_GENERAL_ADMIN_CAJA"
        TreeNode33.Tag = ""
        TreeNode33.Text = "CAJA"
        TreeNode34.Name = "NODO_GENERAL_ADMIN_PROVEEDORES"
        TreeNode34.Tag = "4c"
        TreeNode34.Text = "PROVEEDORES"
        TreeNode35.Name = "NODO_GENERAL_ADMIN_VENC"
        TreeNode35.Tag = "4d"
        TreeNode35.Text = "AGENDA DE VENCIMIENTOS"
        TreeNode36.Name = "NODO_GENERAL_ADMIN_EXTRAS_COTIZA"
        TreeNode36.Tag = "4ea"
        TreeNode36.Text = "CAMBIAR COTIZACION MONEDA"
        TreeNode37.Name = "NODO_GENERAL_ADMIN__ELIMINA"
        TreeNode37.Tag = "SUPERADMIN"
        TreeNode37.Text = "ELIMINAR COMPROBANTES Y ASIENTOS"
        TreeNode38.Name = "NODO_GENERAL_ADMIN_EXTRAS"
        TreeNode38.Text = "EXTRAS>>>"
        TreeNode39.Name = "NODO_GENERAL_ADMIN_VENDEDORES"
        TreeNode39.Tag = "4f"
        TreeNode39.Text = "VENDEDORES"
        TreeNode40.Name = "NODO_GENERAL_ADMIN_INFORMES_PUBLI"
        TreeNode40.Tag = "4g"
        TreeNode40.Text = "HISTORIAL PUBLICIDAD"
        TreeNode41.Name = "NODO_GENERAL_ADMIN_INFORMES_VENTAS"
        TreeNode41.Tag = "4h"
        TreeNode41.Text = "HISTORIAL VENTAS"
        TreeNode42.Name = "NODO_GENERAL_ADMIN_INFORMES"
        TreeNode42.Text = "HISTORIALES E INFORMES"
        TreeNode43.Name = "NODO_GENERAL_ADMIN"
        TreeNode43.Tag = "4"
        TreeNode43.Text = "Mod ADMINISTRACION"
        TreeNode44.Name = "NODO_GENERAL_SERVICIOS_ETIQUETAS"
        TreeNode44.Tag = "AR01"
        TreeNode44.Text = "IMPRESION DE ETIQUETAS"
        TreeNode45.Name = "NODO_GENERAL_SERVICIOS_KIBIT"
        TreeNode45.Tag = "5KIBIT"
        TreeNode45.Text = "MODULOS KIBIT"
        TreeNode46.Name = "NODO_GENERAL_SERVICIOS_PRESTAMOS"
        TreeNode46.Tag = "5RYM"
        TreeNode46.Text = "PRESTAMOS"
        TreeNode47.Name = "NODO_GENERAL_SERVICIOS_PUBLI_OPERA"
        TreeNode47.Tag = "5PUBLICIDAD-OPERADORRAD"
        TreeNode47.Text = "VENTANA OPERADOR"
        TreeNode48.Name = "NODO_GENERAL_SERVICIOS_PUBLICIDAD"
        TreeNode48.Tag = "5PUBLICIDAD"
        TreeNode48.Text = "PUBLICIDAD"
        TreeNode49.Name = "Nodo0"
        TreeNode49.Tag = "5ACADEMIA"
        TreeNode49.Text = "ACADEMIA"
        TreeNode50.Name = "NODO_GENERAL_SERVICIOS_TECNICO"
        TreeNode50.Tag = "5TALLER"
        TreeNode50.Text = "TECNICO"
        TreeNode51.Name = "NODO_GENERAL_SERVICIOS_COMBUSTIBLES"
        TreeNode51.Tag = "IMPEXTRA"
        TreeNode51.Text = "COMBUSTIBLES/IMPUESTOS EXTRAS"
        TreeNode52.Name = "NODO_GENERAL_SERVICIOS"
        TreeNode52.Tag = "5"
        TreeNode52.Text = "ESPECIALES-SERVICIOS"
        TreeNode53.Name = "NODO_GENERAL_SUELDOS"
        TreeNode53.Tag = "6"
        TreeNode53.Text = "Mod SUELDOS"
        TreeNode54.Name = "NODO_GENERAL_CONFIGURACIONES_TERMINAL"
        TreeNode54.Tag = "CONFTERM"
        TreeNode54.Text = "CONFIGURAR TERMINAL"
        TreeNode55.Name = "NODO_GENERAL_CONFIGURACIONES_VARIAS"
        TreeNode55.Tag = "CONFVAR"
        TreeNode55.Text = "CONFIGURACIONES VARIAS"
        TreeNode56.Name = "NODO_GENERAL_CONFIGURACIONES_USUARIOS"
        TreeNode56.Tag = "CONFUSER"
        TreeNode56.Text = "HISTORIAL Y CONFIGURACION DE USUARIOS"
        TreeNode57.Name = "NODO_GENERAL_CONFIGURACIONES"
        TreeNode57.Tag = "CONF"
        TreeNode57.Text = "Mod CONFIGURACIONES"
        TreeNode58.Name = "NODO_GENERAL"
        TreeNode58.Tag = "KIGEST_FACT_SIGT"
        TreeNode58.Text = "KIGEST_FACT_SIGT"
        Me.trvmodulos.Nodes.AddRange(New System.Windows.Forms.TreeNode() {TreeNode58})
